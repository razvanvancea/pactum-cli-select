...
1. Navigate to the [pactum-cli-select GitHub repository](https://github.com/razvanvancea/pactum-cli-select.git)
...
>
> ```
> git remote add upstream https://github.com/razvanvancea/pactum-cli-select
> git fetch upstream
...
For open issues, please look into [the open issues](https://github.com/razvanvancea/pactum-cli-select/issues)
